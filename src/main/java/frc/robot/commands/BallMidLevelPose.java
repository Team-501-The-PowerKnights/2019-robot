...
public class BallMidLevelPose
   extends PKBaseCommandGroup
{

   /* Our classes logger */
   private static final Logger logger =
      RioLogger.getLogger( BallMidLevelPose.class.getName() );


   /**
    * 
    */
   public BallMidLevelPose()
   {
      logger.info( "constructing {}", getName() );

      // final double elbowPosition = ElbowSetPoints.ballMid;
      // addSequential( new ElbowGoToIndexedPosition( elbowPosition ) );

      final double liftPosition = LiftSetPoints.ballMid;
