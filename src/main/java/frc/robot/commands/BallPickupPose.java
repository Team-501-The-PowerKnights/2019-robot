...
public class BallPickupPose
   extends PKBaseCommandGroup
{

   /* Our classes logger */
   private static final Logger logger =
      RioLogger.getLogger( BallPickupPose.class.getName() );


   /**
    * Add your docs here.
    */
   public BallPickupPose()
   {
      logger.info( "constructing {}", getName() );

      // final double elbowPosition = ElbowSetPoints.ballPickup;
      // addSequential( new ElbowGoToIndexedPosition( elbowPosition ) );

      final double liftPosition = LiftSetPoints.ballPickup;
