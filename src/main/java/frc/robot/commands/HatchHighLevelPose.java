...
public class HatchHighLevelPose
   extends PKBaseCommandGroup
{

   /* Our classes logger */
   private static final Logger logger =
      RioLogger.getLogger( HatchHighLevelPose.class.getName() );


   /**
    * 
    */
   public HatchHighLevelPose()
   {
      logger.info( "constructing {}", getName() );

      final double elbowPosition = ElbowSetPoints.hatchHigh;
      addSequential( new ElbowGoToIndexedPosition( elbowPosition ) );

      final double liftPosition = LiftSetPoints.hatchHigh;
