...
public class BallLowLevelPose
   extends PKBaseCommandGroup
{

   /* Our classes logger */
   private static final Logger logger =
      RioLogger.getLogger( BallLowLevelPose.class.getName() );


   /**
    * 
    */
   public BallLowLevelPose()
   {
      logger.info( "constructing {}", getName() );

      // final double elbowPosition = ElbowSetPoints.ballLow;
      // addSequential( new ElbowGoToIndexedPosition( elbowPosition ) );

      final double liftPosition = LiftSetPoints.ballLow;
