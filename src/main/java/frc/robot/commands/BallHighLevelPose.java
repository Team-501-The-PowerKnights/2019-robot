...
public class BallHighLevelPose
   extends PKBaseCommandGroup
{

   /* Our classes logger */
   private static final Logger logger =
      RioLogger.getLogger( BallHighLevelPose.class.getName() );


   /**
    * 
    */
   public BallHighLevelPose()
   {
      logger.info( "constructing {}", getName() );

      // final double elbowPosition = ElbowSetPoints.ballHigh;
      // addSequential( new ElbowGoToIndexedPosition( elbowPosition ) );

      final double liftPosition = LiftSetPoints.ballHigh;
